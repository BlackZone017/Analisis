...
public class ConsultaSucursales {
    ...
    String [] columnas={"Nombre_Gerente","Direccion","Telefono","Correo"};
    ...
    ModeloTabla=new DefaultTableModel(null,columnas);      
     ...
     SSQL = "SELECT * FROM Sucursal";
        ...
        while (rs.next()){
             registros[0]=rs.getString("Nombre_Gerente");
    ...
    ModeloTabla=new DefaultTableModel(null,columnas);      
     ...
     SSQL = "SELECT * FROM Sucursal WHERE "+cbo+"LIKE '%"+valor+"%'";
               try {
    ...
    try{
        PreparedStatement pstm = conect.prepareStatement("DELETE FROM Sucursal WHERE Nombre_Gerente=?");
