...
public class ConsultaProveedores {
    ...
    String [] columnas={"id_Proveedor","nom_proveedor","ape_proveedor","Telefono","Correo"};
    ...
    ModeloTabla=new DefaultTableModel(null,columnas);      
     ...
     SSQL = "SELECT * FROM Proveedor";
        ...
        while (rs.next()){
             ...
             registros[1]=rs.getString("nom_proveedor");
             registros[2]=rs.getString("ape_proveedor");
    ...
    ModeloTabla=new DefaultTableModel(null,columnas);      
     ...
     SSQL = "SELECT * FROM Proveedor WHERE "+cbo+"LIKE '%"+valor+"%'";
               try {
    ...
    try{
        PreparedStatement pstm = conect.prepareStatement("DELETE FROM Proveedor WHERE id_Proveedor=?");
